...
const createUser = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const payload = Object.assign(Object.assign({}, req.body), { picture: (_a = req === null || req === void 0 ? void 0 : req.file) === null || _a === void 0 ? void 0 : _a.path });
...
const sendDoctorRequest = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const decodedToken = req.user;
    yield user_service_1.userService.sendDoctorRequest(decodedToken.userId);
    (0, sendResponse_1.sendResponse)(res, {
        data: null,
...
const getAllPendingRequest = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const query = req.query;
    const allPendingReq = yield user_service_1.userService.getAllPendingRequest(query);
    (0, sendResponse_1.sendResponse)(res, {
        data: allPendingReq.data,
        message: "Request sent",
        statusCode: http_status_codes_1.default.OK,
        success: true,
        meta: Object.assign(Object.assign({}, allPendingReq.meta), { total: allPendingReq === null || allPendingReq === void 0 ? void 0 : allPendingReq.data.length })
    });
}));
