...
import { DoctorRequest, Role } from "./user.interface.js";
...
const createUser = async (payload) => {
    ...
    const hashPassword = bcrypt.hashSync(payload.password, parseInt(envVars.BCRYPT_SALT));
    const authProvider = {
...
const sendDoctorRequest = async (userId) => {
...
const getAllPendingRequest = async (query) => {
